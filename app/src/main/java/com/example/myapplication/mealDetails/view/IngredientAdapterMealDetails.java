...
public class IngredientAdapterMealDetails extends RecyclerView.Adapter<IngredientAdapterMealDetails.ViewHolder>{

        private static final String TAG ="tag";
        private List<IngredientModel> ingredients;
        private Context context;
        public IngredientAdapterMealDetails(Context context, List<IngredientModel> ingredients){
